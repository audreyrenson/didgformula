...
generate_parameters <- function(Tt, mu_Beta_L=0.2, mu_Beta_A=0.2,
                                ...
                                constant_dydu = 0.1, ylink='identity') {
  ...
  Beta_Y = fix_dydu(Beta_Y, constant_dydu, ylink) #constant effect of U0 = part of parallel trends
...
fix_dydu <- function(Beta_Y, constant_dydu, ylink) {
